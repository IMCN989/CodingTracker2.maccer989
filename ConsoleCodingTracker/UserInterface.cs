...
namespace ConsoleCodingTracker
{
    ...
    class UserInterface
    {
        ...
        private static (int, string, string) CalculateDuration()
        {
        ...
        static void UpdateSession(SqliteCrud sql)
        {
            ...
            recordId = Validation.CheckValidRecord(sql, recordId);
            string startTime ;
            string endTime;
            int duration;
            DateTime currentDateTime = DateTime.Now;
            string dateTime = currentDateTime.ToString();
            (duration, startTime, endTime) = CalculateDuration();
            sql.UpdateCodingSession(recordId, startTime, endTime, duration, dateTime);
        }
        ...
        static string GetTime(string message)
        {
            ...
            Validation.CheckValidTime(timeInput);          
            return timeInput;
        }
